            ...
            <div className='bg-gray-50 p-8 rounded-lg mb-12'>
              <div className='flex flex-col md:flex-row gap-8'>
                ...
                <div className='md:w-1/2'>
                  ...
                  <p className='font-bold text-xl mb-2'>AUD5,200</p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-12'>
              ...
              <div className='bg-white p-6 rounded-lg shadow-md'>
                ...
                <div className='space-y-4'>
                  <a href='https://olylifeglobal.com/' target='_blank' rel='noopener noreferrer' className='btn btn-secondary block w-full text-center'>
                    Read More
                  </a>
                  <Link href='/discovery-call?service=purchase#discovery-form' className='btn btn-outline block w-full text-center'>
                    Contact for Purchase
                  </Link>
                </div>
              </div>
