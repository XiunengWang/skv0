        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto">
            <div className="mb-8 flex justify-center">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/EnergyAudit-Service.jpg-mHF4ntTrGe1fBCqkrIbaEJsy7HFdME.jpeg"
                alt="Energy Audit Service - MiHealth device with spiritual elements"
                width={600}
                height={800}
            ...
            <div id="registration-form" className="bg-gray-50 p-8 rounded-lg shadow-md mb-8">
              ...
              <p className="mb-6">
                Our cutting-edge E4L Bioenergetic Scan uses your voice to uncover hidden traumas impacting your vitality
                and well-being, identify recurring thought patterns that are limiting your potential, and discover real
                support for breakthrough and lasting change.
              </p>
