      ...
      <div className='container-custom py-12'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          <div>
            ...
            <p className='mb-4'>Restore your mental, physical and emotional health with Energy4Life - A Bioenergetic Healing System.</p>
          </div>
          ...
          <div>
            ...
            <ul className='space-y-2'>
              ...
              <li>
                <Link href='/discovery-call?service=default#discovery-form' className='hover:underline'>
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className='space-y-2'>
              ...
              <div className='mt-4'>
                <Link href='/discovery-call?service=default#discovery-form' className='btn bg-white text-teal-800 hover:bg-gray-100'>
